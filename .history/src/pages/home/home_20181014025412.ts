...
import { IonicPage, NavController, Platform, NavParams, ModalController, ViewController,AlertController } from 'ionic-angular';
...
export class HomePage {
  ...
  constructor(public navCtrl: NavController, public modalCtrl: ModalController , public navParams: NavParams, public api:ApiRequestProvider, public cart:CartProvider) {
    }

    loginUser(){
      this.api.pageLoading('Loggin in...');
      this.actions = "&actions=loginusernew";
...
@Component({
  ...
  saveuser(){
    ...
    this.data = "&usname="+this.usname+"&pwd="+this.pwd; 
