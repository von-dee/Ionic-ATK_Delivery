...
export class FoodsPage {
  ...
  column: string = 'name';searchQuery: string = '';items: string[];orderPlaced_showmap: boolean = false;ads: any;restaurant_details:any;
  rest_name: any;rest_description: any;rest_location: any;rest_phone: any;rest_rate: any;rest_id: any;
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams,  public popoverCtrl: PopoverController, public pop: Popoverprovider, public apiReq:ApiRequestProvider, public cart:CartProvider, public storage: Storage) {
    ...
    console.log("Res details ", this.restaurant_details);
  }
